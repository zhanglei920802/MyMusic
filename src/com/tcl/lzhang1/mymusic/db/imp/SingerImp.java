 ...
 * @author leizhang
 */
public class SingerImp implements DBOperator {
    private Context mContext = null;
    private DBHelper mDbHelper = null;

    private String LOG_TAG = "";

    public SingerImp(Context context) {
        // TODO Auto-generated constructor stub
        mContext = context;
        mDbHelper = new DBHelper(mContext);
        LOG_TAG = mContext.getPackageName() + "/" + SingerImp.class.getSimpleName();
    }
    ...
    public List<? extends BaseModel> findAll(String sql) {
        // TODO Auto-generated method stub
        List<SingerModel> songs = new ArrayList<SingerModel>();
        SingerModel model;
        ...
        if (null != db) {
            ...
            while (datas.moveToNext()) {
                ...
                {
                    model.setSinger_id(datas.getString(datas.getColumnIndex("singername")));
                    model.setSinger_name(datas.getString(datas.getColumnIndex("singername")));
